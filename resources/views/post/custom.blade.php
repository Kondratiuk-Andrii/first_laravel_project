        ...
        <div class="edit-post">
            ...
            <form action="{{ route('post.update', $post->id) }}" method="POST" class="edit-post__form">
                ...
                <div class="edit-post__field">
                    ...
                    <textarea name="content" id="content" class="edit-post__textarea" rows="5" value="{{ $post->content }}"></textarea>
                </div>
                <div class="edit-post__field">
                    <label for="image" class="edit-post__label">Image:</label>
                    <input class="edit-post__input" type="number" name="likes" id="likes"
                        value="{{ $post->likes }}">
                    <div class="edit-post__field">
                        <label for="likes" class="edit-post__label">Likes:</label>
                        <input class="edit-post__input" type="text" name="likes" id="likes"
                            value="{{ $post->likes }}">
                    </div>
                    <div class="edit-post__field">
